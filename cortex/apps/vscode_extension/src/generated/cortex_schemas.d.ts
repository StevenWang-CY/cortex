...
// Source SHA-256: 810d8dfa4780c406672d10e6c773c0f591c343695f4a7e2c709b803410e64ee5
...
export interface AuthOkPayload {
  selected_protocol_version: "1.0" | "2.0";
...
export interface AuthRequestPayload {
  auth_token: string;
  /**
   * Preferred major.minor version; absent means legacy 1.0
   */
  protocol_version?: string | null;
  /**
   * Versions the client can decode, newest preference optional
   *
   * @maxItems 8
   */
...
export interface ConsentLevelResponse {
  schema_version?: "1.0" | "2.0";
  observed_at_unix_ms?: number;
  observed_at_mono_ns?: number;
  boot_id?: string;
...
export interface ConsentRecord {
  ...
  approved: boolean;
  /**
   * Timezone-aware UTC instant when the decision was made
   */
  timestamp?: string;
}
/**
 ...
 */
export interface ConsentResetRequest {}
export interface ConsentResetResponse {
  schema_version?: "1.0" | "2.0";
  observed_at_unix_ms?: number;
  observed_at_mono_ns?: number;
  boot_id?: string;
...
export interface DashboardRaiseRequest {
  target?: string | null;
}
export interface DashboardRaiseResponse {
  schema_version?: "1.0" | "2.0";
  observed_at_unix_ms?: number;
  observed_at_mono_ns?: number;
  boot_id?: string;
 ...
 */
export interface DualClockModel {
  schema_version?: "1.0" | "2.0";
  observed_at_unix_ms?: number;
  observed_at_mono_ns?: number;
  boot_id?: string;
...
export interface FeatureVector {
  /**
   * @deprecated
   * Deprecated v1 state-pipeline monotonic seconds. Compare only inside the producing process; prefer observed_at_mono_ns.
   */
  timestamp: number;
  schema_version?: "2.0";
  /**
   * UTC Unix epoch milliseconds for persistence/display.
   */
  observed_at_unix_ms?: number | null;
  /**
   * Monotonic nanoseconds for elapsed-time decisions.
   */
  observed_at_mono_ns?: number | null;
  /**
...
export interface FrameMeta {
  ...
  schema_version?: "2.0";
  /**
   * Capture time in UTC Unix epoch milliseconds.
   */
  observed_at_unix_ms?: number | null;
  /**
   * Capture time in the producer's monotonic clock domain.
   */
  observed_at_mono_ns?: number | null;
  /**
   * Producer boot ID; required when observed_at_mono_ns is present.
   */
  boot_id?: string | null;
  /**
...
export interface InterventionSnapshot {
  ...
  /**
   * @deprecated
   * Deprecated v1 process-local monotonic seconds.
   */
  timestamp?: number;
  schema_version?: "2.0";
  observed_at_unix_ms?: number | null;
...
export interface HelpfulnessSummaryResponse {
  schema_version?: "1.0" | "2.0";
  observed_at_unix_ms?: number;
  observed_at_mono_ns?: number;
  boot_id?: string;
...
export interface InterventionApplyResponse {
  ...
  correlation_id?: string | null;
  confirmation?: InterventionApplyResult | null;
}
/**
...
export interface WorkspaceSnapshot {
  ...
  /**
   * @deprecated
   * Deprecated v1 process-local monotonic seconds. Compare only inside the producing boot; prefer observed_at_mono_ns.
   */
  timestamp: number;
  schema_version?: "2.0";
  observed_at_unix_ms?: number | null;
...
export interface InterventionRestoreResponse {
  schema_version?: "1.0" | "2.0";
  observed_at_unix_ms?: number;
  observed_at_mono_ns?: number;
  boot_id?: string;
...
export interface StateInferResponse {
  schema_version?: "1.0" | "2.0";
  observed_at_unix_ms?: number;
  observed_at_mono_ns?: number;
  boot_id?: string;
...
export interface WSMessage {
  ...
  /**
   * Envelope schema version. Legacy decoded frames are 1.0.
   */
  schema_version?: string;
  /**
   * Negotiated transport protocol version.
   */
  protocol_version?: string;
  /**
   * Globally unique event identity used for idempotency.
   */
  event_id?: string;
  /**
   * UTC Unix epoch milliseconds for persistence and display.
   */
  sent_at_unix_ms?: number;
  /**
   * Producer-local monotonic nanoseconds for elapsed ordering.
   */
  sent_at_mono_ns?: number;
  /**
   * Producer clock domain; monotonic values compare only within it.
   */
  boot_id?: string;
  /**
   * @deprecated
   * Deprecated v1 compatibility mirror of sent_at_unix_ms in UTC Unix seconds. Never use for elapsed-time decisions.
   */
  timestamp?: number | null;
  /**
  ...
  correlation_id?: string | null;
  /**
   * Event ID or command ID that directly caused this event.
   */
  causation_id?: string | null;
  /**
...
export interface LeetCodeContext {
  ...
  /**
   * @deprecated
   * Deprecated v1 UTC Unix timestamp; historical clients sent milliseconds while some Python callers sent seconds.
   */
  last_submission_ts?: number | null;
  /**
   * Last submission time in UTC Unix epoch milliseconds.
   */
  last_submission_at_unix_ms?: number | null;
  /**
...
export interface PatternLadderRung {
  ...
  /**
   * Reveal time in UTC Unix epoch milliseconds.
   */
  revealed_at_unix_ms?: number | null;
}
/**
...
export interface QuietModeState {
  ...
  /**
   * @deprecated
   * Deprecated v1 UTC Unix-seconds expiry mirror. Prefer ends_at_unix_ms.
   */
  ends_at?: number | null;
  /**
   * UTC Unix epoch milliseconds when the mode lapses.
   */
  ends_at_unix_ms?: number | null;
  /**
...
export interface StateUpdatePayload {
  ...
  /**
   * @deprecated
   * Deprecated v1 producer timestamp with legacy mixed provenance. Use observed_at_unix_ms/observed_at_mono_ns/boot_id.
   */
