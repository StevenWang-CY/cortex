...
export const CX = {
    ...
    textInverse: "var(--cx-label-inverse, #FFFFFF)",
    ...
    success: "var(--cx-success, #30B257)",
    warning: "var(--cx-warning, #D9A100)",
    info: "var(--cx-info, #0A84FF)",
    // Contrast-safe status *text*; the fills above are for dots and bars.
    successText: "var(--cx-success-text, #1B6B3C)",
    warningText: "var(--cx-warning-text, #7A5600)",
    infoText: "var(--cx-info-text, #005BBD)",
    bioHr: "#D97757",
    bioHrv: "#57A0D9",
    bioResp: "#57D99E",
    bioBlink: "#D9B457",
...
export const STATE_TEXT_COLORS: Record<string, string> = {
    ...
    RECOVERY: "var(--cx-info-text, #005BBD)",
};
