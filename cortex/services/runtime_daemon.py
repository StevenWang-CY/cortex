...
class CortexDaemon:
    ...
    async def stop(self) -> None:
        ...
        self._tasks.clear()
        # F05: cancel + drain tracked background tasks (apply-confirmation
        # timeout watchers, etc) so they cannot fire on a half-torn-down
        # daemon. Mirrors the F03 pattern.
