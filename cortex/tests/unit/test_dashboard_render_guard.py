...
def _pyside6_is_mocked() -> bool:
    ...
    that have no ``__file__``. Detecting the mock and re-importing real
    PySide6 segfaults because the C state was already loaded once and
    cannot be re-built in the same process."""
